...
### Added
- New pool logs account (v9)
- Migrating account instruction

### Changed
- Option trade basket structure

## [0.3.3] - 2024-05-30

### Added
- Inline attribute to header getters
...
### Added
- Tests for pools log and buffer

## [0.3.1] - 2024-05-30

### Added
- Pools log account v9
...
### Added
- Getters and setters to worker data

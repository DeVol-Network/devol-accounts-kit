...
pub const POOL_BASKET_SIZE: usize = 104;
pub const POOL_BASKET_LENGTH: usize = 4;
...
pub struct PoolRecordBasket {
    ...
    pub basket_elements: [PoolRecordBasketData; POOL_BASKET_LENGTH], // 24x4=96 bytes
}
...
impl Default for PoolRecordBasket {
    fn default() -> Self {
        Self {
            length: 0,
            basket_elements: [PoolRecordBasketData::default(); POOL_BASKET_LENGTH],
        }
    }
}
...
mod tests {
    ...
    fn test_pools_log_offsets() {
        ...
        assert_eq!(real_size, POOL_BASKET_SIZE);

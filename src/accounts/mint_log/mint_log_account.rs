...
use crate::accounts::mint_log::mint_log::MintLog;
...
mod tests {
    use super::*;
    use std::mem;
    use crate::accounts::mint_log::mint_log::MINT_LOG_SIZE;
    use crate::accounts::mint_log::mint_log_account::{MINT_LOG_BUFFER_CAPACITY, MintLogAccount};

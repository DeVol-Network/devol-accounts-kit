...
pub const PORTFOLIO_POOL_RECORD_SIZE: usize = 8792;
...
pub struct PortfolioPoolRecord {
    ...
    pub client_trades_counter: i64,                 // 8 bytes
    pub pool_trades_counter: i64,                   // 8 bytes
    // worker params
    pub strikes: [i64; BUCKETS_COUNT],              // 760 bytes
    pub bounds: [i64; BOUNDS_COUNT],                // 752 bytes
    // last trade info
    reserved: u32,                                      // 4 bytes (4/8 bytes align)
    ...
    pub calls_cost: [u64; BUCKETS_COUNT],           // 760 bytes
    pub calls_result_pnl: [u64; BUCKETS_COUNT],     // 760 bytes
...
impl Default for PortfolioPoolRecord {
    fn default() -> Self {
        Self {
            ...
            fractions: 0,
            client_trades_counter: 0,
            pool_trades_counter: 0,
            last_trade_time: 0,
